...
BUTTON_ENTITY_MAP = {
    ...
    "ouders_screen_1": {BUTTON_SHORT_INSTA: ('Shade_Slaapkamer', SHADE_COMMAND_TOGGLE_OPEN)},
    "ouders_screen_2": {BUTTON_SHORT_INSTA: ('Shade_Slaapkamer', SHADE_COMMAND_TOGGLE_CLOSE)},
