...
BUTTON_ENTITY_MAP = {
    ...
    "living_screen_1": {BUTTON_SHORT_INSTA: ('Shade_Salon_up', SHADE_COMMAND_TOGGLE_UP)},
    "living_screen_2": {BUTTON_SHORT_INSTA: ('Shade_Salon_down', SHADE_COMMAND_TOGGLE_DOWN)},
